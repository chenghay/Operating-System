...
anon_init()
{
        ...
        anon_allocator=slab_allocator_create("anonyobj",sizeof(mmobj_t));
...
anon_create()
{
        ...
        mmobj_t *new_anoobj=slab_obj_alloc(anon_allocator);
        if(new_anoobj==NULL)
        {
                return NULL;
        }
        mmobj_init(new_anoobj,&anon_mmobj_ops);
        new_anoobj->mmo_refcount=1;
        return new_anoobj;
}
...
anon_lookuppage(mmobj_t *o, uint32_t pagenum, int forwrite, pframe_t **pf)
{
        ...
        pframe_t *temp_pframe;
        int res=pframe_get(o,pagenum,&temp_pframe);
        if(res<0)
        {
                return res;
        }
